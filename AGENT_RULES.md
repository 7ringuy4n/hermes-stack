...
| Secret path refuse + AV via Security Worker | `test/cases/32-secret-probe-path-eicar.md` |
| Zalo image / PDF summary / txt send / queue | `test/cases/33-zalo-image-pdf-txt-queue.md` |
