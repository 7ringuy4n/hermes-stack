...
6. **Schedules:** a numbered list that is one **lịch** (`đặt lịch`, `hằng ngày` / daily / weekly / monthly / yearly, or a one-time clock) stays **one schedule**. Complete every item when it runs. Do not spawn parallel schedules at the same clock.
