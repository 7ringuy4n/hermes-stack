...
| EntryPoint `:443` | HTTPS when `TRAEFIK_ACME_ENABLED=1` |
...
- While product policy is **no public inbound**, keep `TRAEFIK_ACME_ENABLED=0` and terminate TLS on VPN or a reverse proxy elsewhere.
